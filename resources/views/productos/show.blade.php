<x-layouts.layout>
    <div class="flex flex-row justify-center items-center min-h-full bg-gray-300">
        <table class="table-auto bg-white rounded-2xl p-5 divide-y divide-gray-500">
            <thead>
            ...
            <tr class="divide-x divide-black">
                ...
                <td class="px-4 py-2 text-black text-2xl"><span class="font-bold">Email: </span>{{$proveedor->email}}</td>
            </tr>
            <tr class="divide-x divide-black">
            ...
            <tr class="divide-x divide-black">
                <td class="px-4 py-2 text-black text-2xl"><span class="font-bold">Familia: </span>{{$producto->unidades}}</td>
            </tr>
            </tbody>
        </table>
    </div>
